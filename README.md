...
### Lógica Implementada
1.  **Definição de Tokens:** O usuário cadastra palavras válidas (ex: `casa`, `abacaxi`, `livro`). O algoritmo converte essa lista dinamicamente em uma **Matriz de Transição** ($M[estado, simbolo]$).
